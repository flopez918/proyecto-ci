  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Gestión de Orden</span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>empresa"><i class="fa fa-circle-o"></i> Lista de empresas</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Gestión de Inventario</span>
            <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
